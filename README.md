...
This UI was built with tkinter package, and the list on the left side ranks these upcoming animes according to views in total.
...
Choose one of the animes on the left side list, then click the green button named "顯示詳細資訊".
